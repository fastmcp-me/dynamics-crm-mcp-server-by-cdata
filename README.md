[![Add to Cursor](https://fastmcp.me/badges/cursor_dark.svg)](https://fastmcp.me/MCP/Details/1846/dynamics-crm-mcp-server-by-cdata)
[![Add to VS Code](https://fastmcp.me/badges/vscode_dark.svg)](https://fastmcp.me/MCP/Details/1846/dynamics-crm-mcp-server-by-cdata)
[![Add to Claude](https://fastmcp.me/badges/claude_dark.svg)](https://fastmcp.me/MCP/Details/1846/dynamics-crm-mcp-server-by-cdata)
[![Add to ChatGPT](https://fastmcp.me/badges/chatgpt_dark.svg)](https://fastmcp.me/MCP/Details/1846/dynamics-crm-mcp-server-by-cdata)
[![Add to Codex](https://fastmcp.me/badges/codex_dark.svg)](https://fastmcp.me/MCP/Details/1846/dynamics-crm-mcp-server-by-cdata)
[![Add to Gemini](https://fastmcp.me/badges/gemini_dark.svg)](https://fastmcp.me/MCP/Details/1846/dynamics-crm-mcp-server-by-cdata)

# dynamics-crm-mcp-server-by-cdata
CData's Model Context Protocol (MCP) Server for Dynamics CRM

:heavy_exclamation_mark: This project builds a local, read-only MCP server. For fully remote MCP access, check out the first managed MCP platform: [CData Connect AI](https://www.cdata.com/ai/). For locally hosted, full read, write, update, delete, and action capabilities and a simplified setup, check out our [CData MCP Server for Dynamics CRM](https://www.cdata.com/drivers/dynamicscrm/download/mcp/).
## Purpose
We created this read-only MCP Server to allow LLMs (like Claude Desktop) to query live data Dynamics CRM supported by the [CData JDBC Driver for Dynamics CRM](https://www.cdata.com/drivers/dynamicscrm/jdbc/).
...
2. Download and install the CData JDBC Driver for {source}: [https://www.cdata.com/drivers/dynamicscrm/download/jdbc](https://www.cdata.com/drivers/dynamicscrm/download/jdbc/)
3. License the CData JDBC Driver:
    * Navigate to the `lib` folder in the installation directory, typically:
        * (Windows) `C:\Program Files\CData\CData JDBC Driver for Dynamics CRM\`
        * (Mac/Linux) `/Applications/CData JDBC Driver for Dynamics CRM/`
    * Run the command `java -jar cdata.jdbc.dynamicscrm.jar --license`
    * Enter your name, email, and "TRIAL" (or your license key).
4. Configure your connection to the data source (Salesforce as an example):
    * Run the command `java -jar cdata.jdbc.dynamicscrm.jar` to open the Connection String utility.
...
5. Create a `.prp` file for your JDBC connection (e.g. `dynamics-crm.prp`) using the following properties and format:
